...
from .task_malopolska import run_malopolska
import argparse
...
def cli() -> None:
    ...
    parser.add_argument(
        ...
        "-tn",
        action="store",
        choices=["task", "boleslaw", "clouds", "malopolska"],
        required=True,
        type=str,
        dest="task_name",
    )
    ...
    elif args.task_name == "malopolska":
        run_malopolska(args.sentinel_from, args.sentinel_to)
